  ...
  return ( 
    ...
    <div className='flex  items-center justify-between'>
        <div className='flex gap-1 items-center' >
            ...
            <span className='text-black font-extrabold  text-2xl'>Shopee</span></Link>
        </div>
    ...
    <div className='absolute z-50 top-full w-full flex justify-center'>
       ...
       <span className='relative  w-20' onMouseEnter={() => setIsDropdownOpen(true)} onMouseLeave={() => setIsDropdownOpen(false)}>
      ...
      <img src='/shopping_cart.png' className='h-8' alt='absolute Shopping Cart' />
      {cart_items?.length > 0 && (
        ...
        {cart_items?.length}
          ...
          {!token && <>
           <Link href={"/login"}>
        <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-2 rounded flex items-center">
        ...
        <Link href={"/signup"}>
        <button class="   hover:bg-blue-700 bg-blue-500 text-white font-bold py-1 px-2 rounded flex items-center">
        <svg class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
